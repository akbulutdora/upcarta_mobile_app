...
class AppRouter extends _i14.RootStackRouter {
  ...
  final Map<String, _i14.PageFactory> pagesMap = {
    ...
    SeeAll_InspiringPeopleRoute.name: (routeData) {
      return _i14.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i1.SeeAll_InspiringPeople());
    },
    SeeAll_FeaturedCollectionsRoute.name: (routeData) {
      return _i14.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i5.SeeAll_FeaturedCollections());
    },
    ...
    CollectionsAndAsks_RecentRoute.name: (routeData) {
      return _i14.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i1.CollectionsAndAsks_Recent());
    },
    CollectionsAndAsks_PopularRoute.name: (routeData) {
      return _i14.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i1.CollectionsAndAsks_Popular());
    },
    ContentArchive_MostRecommendedRoute.name: (routeData) {
      return _i14.AdaptivePage<dynamic>(
          routeData: routeData,
          child: const _i6.ContentArchive_MostRecommended());
    },
    ContentArchive_RecentRoute.name: (routeData) {
      return _i14.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i7.ContentArchive_Recent());
    },
    RecentAsks_RecentRoute.name: (routeData) {
      return _i14.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i8.RecentAsks_Recent());
    },
    RecentAsks_PopularRoute.name: (routeData) {
      return _i14.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i9.RecentAsks_Popular());
    },
    InspiringPeople_CreatorsRoute.name: (routeData) {
      return _i14.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i10.InspiringPeople_Creators());
    },
    InspiringPeople_CommunityRoute.name: (routeData) {
      return _i14.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i11.InspiringPeople_Community());
    },
    FeaturedCollections_RecentlyFeaturedRoute.name: (routeData) {
      return _i14.AdaptivePage<dynamic>(
          routeData: routeData,
          child: const _i12.FeaturedCollections_RecentlyFeatured());
    },
    FeaturedCollections_PopularRoute.name: (routeData) {
      return _i14.AdaptivePage<dynamic>(
          routeData: routeData,
          child: const _i13.FeaturedCollections_Popular());
    },
  ...
  List<_i14.RouteConfig> get routes => [
        ...
        _i14.RouteConfig(EditProfileRoute.name, path: 'edit_profile'),
        _i14.RouteConfig(SettingsRoute.name, path: 'settings'),
        _i14.RouteConfig(NotificationSettingsRoute.name,
            path: 'notification_settings'),
        _i14.RouteConfig(SeeAll_CollectionsAndAsksRoute.name,
            ...
            children: [
              _i14.RouteConfig('#redirect',
                  ...
                  redirectTo: 'recent',
                  fullMatch: true),
              _i14.RouteConfig(CollectionsAndAsks_RecentRoute.name,
                  path: 'recent', parent: SeeAll_CollectionsAndAsksRoute.name),
              _i14.RouteConfig(CollectionsAndAsks_PopularRoute.name,
                  path: 'popular', parent: SeeAll_CollectionsAndAsksRoute.name)
            ]),
        _i14.RouteConfig(SeeAll_ContentArchiveRoute.name,
            ...
            children: [
              _i14.RouteConfig('#redirect',
                  ...
                  fullMatch: true),
              _i14.RouteConfig(ContentArchive_MostRecommendedRoute.name,
                  path: 'most_recommended',
                  parent: SeeAll_ContentArchiveRoute.name),
              _i14.RouteConfig(ContentArchive_RecentRoute.name,
                  path: 'recent', parent: SeeAll_ContentArchiveRoute.name)
            ]),
        _i14.RouteConfig(SeeAll_RecentAsksRoute.name,
            ...
            children: [
              _i14.RouteConfig('#redirect',
                  ...
                  redirectTo: 'recent',
                  fullMatch: true),
              _i14.RouteConfig(RecentAsks_RecentRoute.name,
                  path: 'recent', parent: SeeAll_RecentAsksRoute.name),
              _i14.RouteConfig(RecentAsks_PopularRoute.name,
                  path: 'popular', parent: SeeAll_RecentAsksRoute.name)
            ]),
        _i14.RouteConfig(SeeAll_PopularTopicsRoute.name,
            path: 'see_all_popular_topics'),
        _i14.RouteConfig(SeeAll_InspiringPeopleRoute.name,
            ...
            children: [
              _i14.RouteConfig('#redirect',
                  ...
                  redirectTo: 'creators',
                  fullMatch: true),
              _i14.RouteConfig(InspiringPeople_CreatorsRoute.name,
                  path: 'creators', parent: SeeAll_InspiringPeopleRoute.name),
              _i14.RouteConfig(InspiringPeople_CommunityRoute.name,
                  path: 'community', parent: SeeAll_InspiringPeopleRoute.name)
            ]),
        _i14.RouteConfig(SeeAll_FeaturedCollectionsRoute.name,
            ...
            children: [
              _i14.RouteConfig('#redirect',
                  ...
                  fullMatch: true),
              _i14.RouteConfig(FeaturedCollections_RecentlyFeaturedRoute.name,
                  path: 'recently_featured',
                  parent: SeeAll_FeaturedCollectionsRoute.name),
              _i14.RouteConfig(FeaturedCollections_PopularRoute.name,
        ...
        _i14.RouteConfig(LoginScreen2Route.name, path: '/login2'),
        _i14.RouteConfig(ResetPasswordRoute.name, path: '/forgot'),
        _i14.RouteConfig(ResetPasswordNewRoute.name, path: '/forgot_new'),
        _i14.RouteConfig(MyRegisterRoute.name, path: '/register'),
        _i14.RouteConfig(MyRegisterConfirmRoute.name,
            path: '/register_confirm'),
        _i14.RouteConfig(LandingPageRoute.name, path: '/landing_page'),
        _i14.RouteConfig(NotificationsScreenRoute.name, path: '/notifications'),
        _i14.RouteConfig(OnboardingScreenRoute.name,
            path: '/onboarding',
            children: [
              _i14.RouteConfig(UserOnboarding1Route.name,
                  path: '', parent: OnboardingScreenRoute.name),
              _i14.RouteConfig(UserOnboarding2Route.name,
                  path: 'userOnboarding2', parent: OnboardingScreenRoute.name),
              _i14.RouteConfig(UserOnboarding3Route.name,
                  path: 'userOnboarding3', parent: OnboardingScreenRoute.name),
              _i14.RouteConfig(UserOnboarding4Route.name,
        ...
        _i14.RouteConfig(HomeRoute.name, path: '/home', children: [
          _i14.RouteConfig(FeedScreenRoute.name,
              path: 'feed',
              ...
              children: [
                _i14.RouteConfig('#redirect',
                    ...
                    redirectTo: 'latest',
                    fullMatch: true),
                _i14.RouteConfig(LatestScreenRoute.name,
                    path: 'latest', parent: FeedScreenRoute.name),
                _i14.RouteConfig(TopScreenRoute.name,
                    path: 'top', parent: FeedScreenRoute.name)
              ]),
          _i14.RouteConfig(ExploreScreenRoute.name,
              path: 'explore', parent: HomeRoute.name),
          _i14.RouteConfig(NewPostScreenRoute.name,
              path: 'new', parent: HomeRoute.name),
          _i14.RouteConfig(MyLibraryScreenRoute.name,
...
class NotificationSettingsRoute extends _i14.PageRouteInfo<void> {
...
class SeeAll_CollectionsAndAsksRoute extends _i14.PageRouteInfo<void> {
  const SeeAll_CollectionsAndAsksRoute({List<_i14.PageRouteInfo>? children})
...
class SeeAll_ContentArchiveRoute extends _i14.PageRouteInfo<void> {
  const SeeAll_ContentArchiveRoute({List<_i14.PageRouteInfo>? children})
...
class SeeAll_RecentAsksRoute extends _i14.PageRouteInfo<void> {
  const SeeAll_RecentAsksRoute({List<_i14.PageRouteInfo>? children})
...
class SeeAll_PopularTopicsRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i1.SeeAll_InspiringPeople]
class SeeAll_InspiringPeopleRoute extends _i14.PageRouteInfo<void> {
  const SeeAll_InspiringPeopleRoute({List<_i14.PageRouteInfo>? children})
...
/// generated route for
/// [_i5.SeeAll_FeaturedCollections]
class SeeAll_FeaturedCollectionsRoute extends _i14.PageRouteInfo<void> {
  const SeeAll_FeaturedCollectionsRoute({List<_i14.PageRouteInfo>? children})
...
/// generated route for
/// [_i1.LoginScreen2]
class LoginScreen2Route extends _i14.PageRouteInfo<void> {
...
class ResetPasswordNewRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i1.MyRegister]
class MyRegisterRoute extends _i14.PageRouteInfo<void> {
...
class MyRegisterConfirmRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i1.LandingPage]
class LandingPageRoute extends _i14.PageRouteInfo<void> {
...
class NotificationsScreenRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i1.CollectionsAndAsks_Recent]
class CollectionsAndAsks_RecentRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i1.CollectionsAndAsks_Popular]
class CollectionsAndAsks_PopularRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i6.ContentArchive_MostRecommended]
class ContentArchive_MostRecommendedRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i7.ContentArchive_Recent]
class ContentArchive_RecentRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i8.RecentAsks_Recent]
class RecentAsks_RecentRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i9.RecentAsks_Popular]
class RecentAsks_PopularRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i10.InspiringPeople_Creators]
class InspiringPeople_CreatorsRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i11.InspiringPeople_Community]
class InspiringPeople_CommunityRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i12.FeaturedCollections_RecentlyFeatured]
class FeaturedCollections_RecentlyFeaturedRoute
    extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i13.FeaturedCollections_Popular]
class FeaturedCollections_PopularRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i1.UserOnboarding1]
class UserOnboarding1Route extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i1.UserOnboarding2]
class UserOnboarding2Route extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i1.UserOnboarding3]
class UserOnboarding3Route extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i1.UserOnboarding4]
class UserOnboarding4Route extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i1.FeedScreen]
class FeedScreenRoute extends _i14.PageRouteInfo<void> {
  const FeedScreenRoute({List<_i14.PageRouteInfo>? children})
...
/// generated route for
/// [_i1.ExploreScreen]
class ExploreScreenRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i1.NewPostScreen]
class NewPostScreenRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i1.MyLibraryScreen]
class MyLibraryScreenRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i1.LatestView]
class LatestScreenRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for
/// [_i1.TopView]
class TopScreenRoute extends _i14.PageRouteInfo<void> {
